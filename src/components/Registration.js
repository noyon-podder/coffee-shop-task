    ...
    <section className="lg:pt-20 lg:pb-20 pt-10 pb-10">
      <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md ">
        ...
        <button
          ...
          type="button"
          className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-orange-400 rounded-lg hover:bg-orange-500 focus:bg-orange-400 focus:outline-none"
        >
